...
const songs = [
    {
        name: 'jacinto-1',
        displaName: 'Electric Chill Machine',
        artist: 'Jacinto'
    },
    {
        name: 'jacinto-2',
        displaName: 'Seven Nation Army (Remix)',
        artist: 'Jacinto'
    },
    {
        name: 'jacinto-3',
        displaName: 'Goodnight, Disco Queen',
        artist: 'Jacinto'
    },
    {
        name: 'metric-1',
        displaName: 'Front Row (Remix)',
...
function loadSong(song){
    title.textContent = song.displaName
